...
namespace PacMan.Agent.PathFinding
{
    public class Astar
    {
        ...
        /// <param name="enemyPositions">List of enemy positions. </param>
        ...
        public List<Vector3> PlanPathAStar(Vector3 start, Vector3 goal, 
            List<Vector3> enemyPositions, Dictionary<Vector2Int, VoronoiCellData> voronoiMap = null)
        {
        ...
        private class AStarNode
        {
            ...
            /// <param name="enemyPositions">The enemy positions. </param>
